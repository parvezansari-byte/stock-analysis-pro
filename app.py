...
# =========================================================
# EMBEDDED LOGO (YOUR IMAGE)
# =========================================================
# NOTE:
# This is your uploaded logo embedded directly so Streamlit Cloud can show it
# without needing a separate image file.

LOGO_BASE64 = """
iVBORw0KGgoAAAANSUhEUgAAAlgAAAGuCAIAAADzW0G0AACbqklEQVR4nOz9ebQk13kfiP5Wfdd9
n+6qqnq6e+Ywz+AMGkCwAAbAAoQkQhYlI0m6y9n2k8S5Jk2b3t+2sYxvYvW3b1p9r2d2f7+1xk2w9k
4m8bM4n8xj4wQJjGmAA0JgkB2D1V1V3d1d1V1f3e+z7n9+9n5r8zq6u7q6u6q7u7u6v3f7y6l1z7gE
...
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
"""
# NOTE: Replace the LOGO_BASE64 string above with your full base64 if needed.
# The app still works even if logo fails to render.
...
def render_logo():
    try:
        ...
        <div style="display:flex; align-items:center; gap:14px;">
            <img src="data:image/png;base64,{LOGO_BASE64.strip()}" width="70" style="border-radius:12px; background:#e5e7eb; padding:6px;" />
            <div>
                <div style="font-size:2.1rem; font-weight:800; color:#f8fafc; line-height:1;">Nile</div>
                <div style="font-size:0.95rem; color:#93c5fd; font-weight:600;">Professional Stock Analysis Platform</div>
            </div>
        </div>
        """
...
def plot_candlestick(df, symbol):
    ...
    fig.update_layout(
        title=f"{symbol} | Nile Stock Chart",
...
render_logo()
st.markdown("""
<div style="margin-top:10px; color:#93c5fd; font-weight:600;">
FINAL V12.1.5.1 • 100 Stocks • Attractive Buttons • Premium Solid Theme • Cloud Safe
</div>
</div>
""", unsafe_allow_html=True)
...
if mode == "Single Stock Analysis":
    ...
    tabs = st.tabs(["📊 Premium Chart", "🎯 Trade Setup", "🏢 Fundamentals", "📑 Financials", "🕯️ Pattern & Levels", "🧠 AI Summary"])
...
# =========================================================
    ...
    st.caption(f"Universe Size: {len(DEFAULT_STOCKS)} stocks")
...
# =========================================================
st.markdown("---")
st.caption(f"Nile | 100 Stocks | Last Loaded: {datetime.now().strftime('%d-%m-%Y %H:%M:%S')}")
st.caption("Cloud-safe notes: Nile branding • logo support • attractive buttons • 100 stock scanner • premium chart • stable deploy-safe structure")
